...
import com.example.meetingroomreservationapi.service.ReservationFacadeImpl;
...
public class ReservationController {
    ...
    @Autowired
    ReservationFacadeImpl reservationService;
    ...
    public ResponseEntity<List<Room>> getAvailableRooms() {
        return new ResponseEntity<>(reservationService.getAvailableRooms(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<Reservation>> waitingReserveRequest() {
        return new ResponseEntity<>(reservationService.getWaitingList(), HttpStatus.OK);
    }
